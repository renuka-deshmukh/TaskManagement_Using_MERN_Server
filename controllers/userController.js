...
const baseURL = 'https://taskmanagement-using-mern-server.onrender.com/download/'
...
async function getAllUsers(req, res) {
    try {
        ...
        users.forEach(user => {
            if (user.avatar) {
                user.avatar = `https://taskmanagement-using-mern-server.onrender.com/download/${user.avatar}`;
            }
        });
